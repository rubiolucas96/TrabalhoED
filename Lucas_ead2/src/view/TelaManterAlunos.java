...
public TelaManterAlunos() {
		...
		panelBotoes.setBounds(0, 500, 1020, 100); // Definir a posição e tamanho do painel de botões
		panelBotoes.setBackground(Color.BLACK);
		contentPane.add(panelBotoes);
		panelBotoes.setLayout(new FlowLayout(FlowLayout.CENTER, 20, 10)); // Usar FlowLayout para centralizar os botões e definir o espaçamento

		// Adicionar os botões ao painel de botões

		JButton btnGravar_1 = new JButton("Enviar");
		btnGravar_1.setPreferredSize(new Dimension(120, 40)); // Definir um tamanho preferido para o botão
		...
		lblInserindoAlunos.setForeground(Color.WHITE); // Definir a cor do texto como branca
		lblInserindoAlunos.setFont(new Font("Tahoma", Font.BOLD, 16)); // Definir a fonte em negrito
